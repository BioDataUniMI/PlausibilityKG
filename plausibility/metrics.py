...
def performance(negatives : set, predicted_negatives : set, positives : set = set()) -> dict :
    ...
    # just to evaluate the metric, all those edges that are positively predicted    
    # they were not predicted as negative arcs, being that strategies do not give us answers
    # indications regarding positive arcs
